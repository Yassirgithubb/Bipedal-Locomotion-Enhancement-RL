...
custom_flags="--nv --writable -B $ISAAC_WS/legged_gym:/isaac_ws/legged_gym"

echo $custom_flags

singularity shell $custom_flags $ISAAC_WS/legged_gym/containers/singularity/leggedgym.sif
