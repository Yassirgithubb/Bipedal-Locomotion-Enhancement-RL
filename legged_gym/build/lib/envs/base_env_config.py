...
from legged_gym.common.gym_interface import GymInterfaceCfg
...
class EnvCfg:
    ...
    send_timeouts: bool = MISSING  # send time out information to the algorithm
    """Whether to send episode time-out information (added as part of infos)."""

    enable_debug_vis: bool = MISSING
    """Whether to enable debug visualization (valid when running with rendering)."""
