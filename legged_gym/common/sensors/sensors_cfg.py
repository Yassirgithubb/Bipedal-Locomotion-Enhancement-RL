...
from legged_gym.common.sensors.sensor_utils import grid_pattern, bpearl_pattern, realsense_pattern
...
@configclass
class CassieSensor(SensorsCfg):
    height_scanner = RaycasterCfg(attachement_pos=(0.0, 0.0, 20.0), attach_yaw_only=True, pattern_cfg=GridPatternCfg(), body_attachement_name='pelvis')