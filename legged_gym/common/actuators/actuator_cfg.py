...
""" Instances """
anymal_simple_actuator_cfg = DCMotorCfg(
    gear_ratio=1.0,
    peak_motor_torque=120.0,
    motor_velocity_limit=7.5,
)

anymal_c_actuator_cfg = ActuatorNetLSTMCfg(
    network_file="{LEGGED_GYM_ROOT_DIR}/resources/actuator_nets/sea_lstm_jit3.pt",
    gear_ratio=1.0,
    peak_motor_torque=120.0,
    motor_velocity_limit=7.5,
...
anymal_d_actuator_cfg = ActuatorNetMLPCfg(
    network_file="{LEGGED_GYM_ROOT_DIR}/resources/actuator_nets/anymal_d_actuator.jit",
    gear_ratio=1.0,
...
wheel_actuator = ActuatorCfg(
    control_type="explicit",
    command_type="V",
    enable_torque_sensor=False,
