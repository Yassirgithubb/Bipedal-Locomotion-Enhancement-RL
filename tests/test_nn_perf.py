"""
Test runtime throughput of different NN architectures.
"""
...
def profile(model: torch.nn.Module, x: torch.Tensor, benchmark: bool, nb_iters: int):
    # change to benchmark mode
